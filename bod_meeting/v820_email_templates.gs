...
function _eRow_(label, value, valueColor) {
  return (
    "<tr>" +
    '<td style="color:#64748b;padding:4px 0;width:130px;font-size:13px;vertical-align:top;font-family:Arial,sans-serif;">' +
    label +
    "</td>" +
    '<td style="color:' +
    (valueColor || "#0f172a") +
    ';font-weight:600;font-size:13px;vertical-align:top;font-family:Arial,sans-serif;">' +
    value +
    "</td>" +
    "</tr>"
  );
...
function _buildHistoryTable_(deptName, history) {
  ...
  for (var i = 0; i < history.weeks.length; i++) {
    ...
    rows +=
      ...
      "</td>" +
      '<td style="padding:6px 10px;font-size:13px;color:' +
      statusColor +
      ';font-weight:600;border-bottom:1px solid #e2e8f0;font-family:Arial,sans-serif;">' +
      statusVN +
      "</td></tr>";
  }
  ...
  return (
    ...
    '<span style="font-size:12px;font-weight:700;color:#334155;font-family:Arial,sans-serif;">TÌNH HÌNH ĐĂNG KÝ — ' +
    deptName +
    "</span>" +
    '<span style="font-size:10px;color:#94a3b8;margin-left:8px;font-family:Arial,sans-serif;">登録状況</span></div>' +
    '<table style="border-collapse:collapse;width:100%;">' +
    rows +
    '<tr><td colspan="2" style="padding:8px 10px;font-size:13px;font-weight:700;color:' +
    summaryColor +
...
function buildReminderEmail(
  ...
  var badgeHtml =
    count > 1
      ? '<div style="text-align:center;padding:10px;background-color:' +
        ...
        badgeColor +
        ';color:#fff;border-radius:20px;font-size:12px;font-weight:700;font-family:Arial,sans-serif;">' +
        "NHẮC NHỞ LẦN " +
        count +
        " / 第" +
        count +
  ...
  var body =
    ...
    '<p style="font-size:15px;font-weight:700;color:#0f172a;margin:0 0 3px;font-family:Arial,sans-serif;">Kính gửi ' +
    name +
    " — " +
    deptName +
    ",</p>" +
    '<p style="font-size:12px;color:#94a3b8;margin:0 0 20px;font-family:Arial,sans-serif;">' +
  ...
  body +=
    '<div style="font-size:12px;line-height:1.65;color:#64748b;margin-bottom:20px;padding:10px 14px;background:#f8fafc;border-radius:8px;border-left:3px solid ' +
    badgeColor +
    ...
    (fUrl
      ? '<div style="text-align:center;margin-bottom:20px;">' +
        ...
        badgeColor +
        ';color:#fff;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;font-family:Arial,sans-serif;">📝 ĐĂNG KÝ NGAY / 今すぐ登録</a>' +
        ...
        '<p style="font-size:11px;color:#3b82f6;margin:2px 0 0;font-family:Arial,sans-serif;word-break:break-all;">' +
        fUrl +
        "</p>" +
        "</div>"
      : "") +
...
function buildApprovalResultEmail(
  ...
  var body =
    ...
    s.color +
    ';opacity:.75;margin-top:2px;font-family:Arial,sans-serif;">' +
    s.labelJP +
    "</div>" +
    "</div></div>" +
    '<div style="font-size:14px;line-height:1.75;color:#334155;margin-bottom:14px;font-family:Arial,sans-serif;">' +
    ...
    s.color +
    ';margin:0 0 8px;font-family:Arial,sans-serif;">CHI TIẾT ĐĂNG KÝ</p>' +
    '<table style="border-collapse:collapse;width:100%;">' +
    _eRow_("Ngày họp:", reportDate) +
  ...
  if (status === "Duyệt") {
    body +=
      '<div style="margin-top:20px;font-size:14px;line-height:1.75;color:#334155;font-family:Arial,sans-serif;">' +
    ...
    // JP block
    body +=
      '<div style="margin-top:16px;font-size:12px;line-height:1.65;color:#64748b;padding:12px 14px;background:#f8fafc;border-radius:8px;border-left:3px solid ' +
      s.color +
      ';font-family:Arial,sans-serif;">' +
...
function buildScheduleEmail(reportDate, scheduleItems) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    rows +=
      ...
      (it.stt || i + 1) +
      "</td>" +
      '<td style="padding:8px 10px;text-align:center;color:#1e40af;font-weight:700;font-size:13px;border-bottom:1px solid #f1f5f9;white-space:nowrap;">' +
      (it.time || "") +
      "</td>" +
      '<td style="padding:8px 10px;color:#0f172a;font-size:13px;border-bottom:1px solid #f1f5f9;">' +
      (it.content || "") +
      "</td>" +
  ...
  if (!rows) {
    rows =
      '<tr><td colspan="6" style="padding:16px;text-align:center;color:#94a3b8;font-size:13px;font-family:Arial,sans-serif;">Chưa có nội dung lịch trình</td></tr>';
  }
